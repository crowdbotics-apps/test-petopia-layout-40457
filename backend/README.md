...
## Project Structure
    ...
    ├── test_petopia_layout_40457  # Django project configurations
...
1. Clone this repo and `cd test_petopia_layout_40457`
...
2. Clone this repo and `cd test_petopia_layout_40457`
